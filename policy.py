...
class Policy(object):
    ...
    def __init__(self, obs_dim, act_dim, kl_targ, hid_list, noise_bias):
        """
        Args:
    ...
    def _placeholders(self):
        ...
        self.kl_targ_ph = tf.placeholder(tf.float32, (), 'kl_targ')
    ...
    def _loss_train_op(self):
        ...
        loss3 = self.eta_ph * tf.square(tf.maximum(0.0, self.kl - 2.0 * self.kl_targ_ph))
